<template>
  <b-modal id="addBank">
    <template #modal-header="{ close }">
      <h5 class="modal-title" id="addBank">Add bank account</h5>
      <b-button
        class="btn-close"
        data-dismiss="modal"
        aria-label="Close"
    ...
    <form action="verify-step-6.html" class="identity-upload">
      <div class="row g-3">
        ...
        <div class="col-xl-12">
          ...
          <input type="text" class="form-control" placeholder="Andrew Smith" />
        </div>
        <div class="col-xl-12">
    ...
    <template #modal-footer="{ ok }">
      <b-button v-b-modal.SuccessModal variant="primary" @click="ok()">
        Confirm
      </b-button>
    </template>
  </b-modal>
